...
function buildRepoRcPrompt(rawPrompt: string, workspacePath: string | null, componentName: string | null): string {
  ...
  return [
    ...
    "- Start by analyzing market and competitor expectations within the single responsibility boundary of the target component.",
    "- Derive separate milestone tracks for technical debt, hardening, fixes, and growth.",
    "- Close each major pass with: What do we have, and what remains?",
    "",
